programa
{
	...
	funcao inicio()
	{
		...
		se (pgto==1)
		{
			escreva("O valor a ser pago será de: " ,(precos[codigo]*0.8))
		}
		senao se (pgto==2)
		{
			escreva("O valor a ser pago será de: " ,(precos[codigo]*0.85))
		}
		senao se (pgto==3)
		{
	          escreva("O valor a ser pago será de: " ,precos[codigo])	
	     }
	     senao se (pgto==4)
		{
	          escreva("O valor a ser pago será de: " ,(precos[codigo]*1.10))	
	     }
	     senao
	     {
	     	escreva("Opção Invalida, comece o processo de escolha novamente")
