programa
{
	...
	funcao inicio()
	{
		...
		inteiro x = 0
		caracter resposta, continua = ' '
		inteiro grupoPessoas
		para (x = 0; x <LIMITE; x++)
		{
			mat[x] = x+1
		}
	...
	/*escreva("Você quer continuar? S para sim, ou N para Não?")
	leia(resposta)
	 se (resposta == 'S' ou resposta == 's')
	 {
	 	escreva("\nDigite Quantos grupos você deseja? ")
	 	leia(grupoPessoas)
	 ...
	 senao {
		...
		faca 
		{
			...
			senao{ continua== 'N' ou resposta == 'n')
			    escreva("\nPrograma finalizado.")
			}
